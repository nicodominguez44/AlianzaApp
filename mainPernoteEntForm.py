...
def mainPernote_EntForm(page: ft.Page):
    ...
    selected_option_text= globals.selected_option_pernocte if globals.selected_option_pernocte != "Sin seleccionar" else "seleccionar pernocte"
    ...
    tf_tren_remis=ft.TextField(value=globals.writed_train_ent,
    ...
    tf_observaciones=ft.TextField(value=globals.writed_obs_ent,
                bgcolor=ft.Colors.WHITE, text_size=14,color=ft.Colors.BLACK, autofocus=False,
                border_radius=ft.border_radius.only(top_left=0,top_right=15,bottom_left=15,bottom_right=15),
    ...
    selected_date_text_value= globals.selected_date_ent if globals.selected_date_ent != "Sin seleccionar" else "Sin seleecionar"
    ...
    selected_time_text_value = globals.selected_time_ent if globals.selected_time_ent != "Sin seleccionar" else "Sin seleecionar"
